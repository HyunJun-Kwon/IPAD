<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	...
	<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
		<nav class="navbar fixed-top navbar-expand-lg">
			<div class="container">
				<!-- LOGO -->
				<a class="navbar-brand fs-4" href="${pageContext.request.contextPath}/main"><img
				...
				<div class="offcanvas offcanvas-start sidebar" tabindex="-1" id="offcanvasNavbar">
					...
					<div class="offcanvas-header border-bottom">
						<h5 class="offcanvas-title" id="offcanvasNavbarLabel"><img
								src="${pageContext.request.contextPath}/img/logo.png" alt=""></h5>
					...
					<div class="offcanvas-body d-flex flex-column flex-lg-row p-4 p-lg-0">
						<ul class="navbar-nav justify-content-center fs-5 flex-grow-1 pe-3">
							<li class="nav-item mx-5"><a class="nav-link"
									href="${pageContext.request.contextPath}/locationRecommand/recommand.do">지역추천</a>
							</li>
							<li class="nav-item mx-5"><a class="nav-link"
							...
							<li class="nav-item mx-5"><a class="nav-link"
									href="${pageContext.request.contextPath}/board/boardList.do">Q&A</a>
							</li>
						</ul>
